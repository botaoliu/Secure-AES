...
REM
REM Generated by Vivado on Sun Nov 17 14:17:31 +0800 2024
...
echo "xvlog --incr --relax -prj CHIP_SASEBO_GIII_AES_vlog.prj"
call xvlog  --incr --relax -prj CHIP_SASEBO_GIII_AES_vlog.prj -log xvlog.log
