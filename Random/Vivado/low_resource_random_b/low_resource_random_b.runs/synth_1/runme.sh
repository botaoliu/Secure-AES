...
HD_PWD='E:/sakura-x/aes/first_order/low_resource_random_b/low_resource_random_b/low_resource_random_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CHIP_SASEBO_GIII_AES.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CHIP_SASEBO_GIII_AES.tcl
